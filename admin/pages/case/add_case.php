<div class="wrap">
	<div class="container-fluid">
		<h1 class="wp-heading-inline">Add Case</h1>
		<a href="admin.php?page=mts_case&action=list" class="page-title-action">View Case</a>
		<p>Create a new Case and add them to this site for client.</p>
		...
		<div class="mts_client_portal_backend_panel">
			<form method="post">
				<table class="form-table" role="presentation">
					<tbody>
						<tr class="form-field form-required">
							...
							<td><input name="case_number" type="text" id="case_number" required></td>
						</tr>
						<tr class="form-field form-required">
							<th scope="row"><label for="lost_amount">Lost Amount</label></th>
							<td><input name="lost_amount" type="text" id="lost_amount" required></td>
						</tr>
						<tr class="form-field form-required">
							<th scope="row"><label for="recovered_founds">Recovered Founds</label></th>
							<td><input name="recovered_founds" type="text" id="recovered_founds" required></td>
						</tr>
						<tr class="form-field form-required">
							<th scope="row"><label for="case_liquidity">Liquidity</label></th>
							<td><input name="case_liquidity" type="text" id="case_liquidity" required></td>
						</tr>
						<tr class="form-field form-required">
							<th scope="row"><label for="required_amount_of_liquidity">Required Amount of Liquidity</label></th>
							<td><input name="required_amount_of_liquidity" type="text" id="required_amount_of_liquidity" required></td>
						</tr>
						<tr class="form-field form-required">
							<th scope="row"><label for="full_withdrawal_balance">Full Withdrawal Balance</label></th>
							<td><input name="full_withdrawal_balance" type="text" id="full_withdrawal_balance" required></td>
						</tr>
						<tr class="form-field form-required">
							<th scope="row"><label for="willer_address">Willer Address</label></th>
							<td><input name="willer_address" type="text" id="willer_address" required></td>
						</tr>
						<tr class="form-field form-required">
							<th scope="row"><label for="case_client">Client</label></th>
							<td>
								<select name="case_client" id="case_client" required>
									<?php
									$args = array(
				...
				<?php wp_nonce_field('new_case'); ?>
				<p class="submit"><input type="submit" name="createCase" class="button button-primary" value="Add New Case"></p>
			</form>
		    ...
		    if(! wp_verify_nonce($_POST['_wpnonce'], 'new_case')){
			...
			if(isset($_POST['createCase'])){
				...
				if($data['case_number'] == '' || $data['lost_amount'] == '' || $data['recovered_founds'] == '' || $data['liquidity'] == '' || $data['required_amount_of_liquidity'] == '' || $data['full_withdrawal_balance'] == '' || $data['willer_address'] == '' || $data['client_id'] == '' || $data['case_status'] == ''){
					...
					$inserted = $wpdb->insert("{$wpdb->prefix}mts_client_portal_case", array(
